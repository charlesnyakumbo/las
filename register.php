                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate action="register.php" method="post">
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" name="first_name" value="<?php echo $first_name; ?>" class="form-control" id="yourName" required>
                      <div class="invalid-feedback">Please, enter your first name!</div>
                    </div>
                    <div class="col-12">
                      <label for="yourName" class="form-label">Last Name</label>
                      <input type="text" name="last_name" value="<?php echo $last_name; ?>" class="form-control" id="yourName" required>
                      <div class="invalid-feedback">Please, enter your last name!</div>
                    </div>
                    <div class="col-12">
                      <label for="yourEmail" class="form-label">Your Email</label>
                      <input type="email" name="username" value="<?php echo $username; ?>" class="form-control" id="yourEmail" required>
                      <div class="invalid-feedback">Please enter a valid Email adddress!</div>
                    </div>
                    <input type="hidden" value="0" name="role_id" value="<?php echo $role_id; ?>" class="form-control" id="yourUsername" required>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        <input class="form-check-input" name="terms" type="checkbox" value="Yes" id="acceptTerms" required>
