          ...
          <div class="col-xl-4">
            ...
            <div class="card">
              <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                ...
                <img src="assets/img/profile-img.j" alt="Profile" class="rounded-circle">
                ...
                <div class="text-center">
                  ...
                  <div class="tab-pane fade pt-3" id="profile-change-password">
                    ...
                    <form class="row g-3 needs-validation" novalidate method="post" autocomplete="off" enctype="multipart/form-data" action="code.php">
                      <input type="hidden" name="user_id" class="form-control" id="currentPassword" value="<?php echo $user_id ?>">
                      <input type="hidden" name="username" class="form-control" id="currentPassword" value="<?php echo $cur_username ?>">
                      <!-- <div class="row mb-3">
