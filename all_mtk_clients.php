...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <li class="nav-item">
        <a class="nav-link " href="mtk_index.php">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="new_mtk_client.php">
              <i class="bi bi-circle"></i><span>New Client</span>
            </a>
          </li>
          <li>
            <a href="all_mtk_clients.php">
...
-->
 ...
 <!-- Recent Sales -->
            <div class="col-18">
              ...
              <div class="">
                  <button  onclick="location.href = 'new_mtk_client.php';"  type="submit" class="btn btn-primary">Add Client</button>
                </div>
                ...
                <div class="card-body">
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <?php 
                                    ...
                                    // $query = "SELECT * FROM checkin where user_id='$user_id'";
